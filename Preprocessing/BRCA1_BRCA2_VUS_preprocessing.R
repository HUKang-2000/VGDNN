...
BRCA1_sam<-matrix(ncol=30,nrow=86)#14:72
BRCA2_sam<-matrix(ncol=30,nrow=79)#6:73

set.seed(12)

for(i in 1:30){
  
  temp_BRCA1<-modelSet_commTrt[which(modelSet_commTrt$GENEINFO=="BRCA1"),]
  index1<-which(temp_BRCA1$CLNSIG=="Benign")
  index2<-sample(1:length(index1),72)
  
  temp_BRCA1_train_B<-temp_BRCA1[index1[-index2],]
  temp_BRCA1_test_B<-temp_BRCA1[index1[index2],]
  
  index1<-which(temp_BRCA1$CLNSIG=="Pathogenic")
  index2<-sample(1:length(index1),14)
  
  temp_BRCA1_train_P<-temp_BRCA1[index1[-index2],]
  temp_BRCA1_test_P<-temp_BRCA1[index1[index2],]
  
  assign(paste("train_",i,"_BRCA1",sep=""),rbind(temp_BRCA1_train_B,temp_BRCA1_train_P))
  assign(paste("test_",i,"_BRCA1",sep=""),rbind(temp_BRCA1_test_B,temp_BRCA1_test_P))
  
  temp_BRCA2<-modelSet_commTrt[which(modelSet_commTrt$GENEINFO=="BRCA2"),]
  
  index1<-which(temp_BRCA2$CLNSIG=="Benign")
  index2<-sample(1:length(index1),73)
  temp_BRCA2_train_B<-temp_BRCA2[index1[-index2],]
  temp_BRCA2_test_B<-temp_BRCA2[index1[index2],]
  
  index1<-which(temp_BRCA2$CLNSIG=="Pathogenic")
  
  index2<-sample(1:length(index1),6)
  
  temp_BRCA2_train_P<-temp_BRCA2[index1[-index2],]
  temp_BRCA2_test_P<-temp_BRCA2[index1[index2],]
  
  assign(paste("train_",i,"_BRCA2",sep=""),rbind(temp_BRCA2_train_B,temp_BRCA2_train_P))
  assign(paste("test_",i,"_BRCA2",sep=""),rbind(temp_BRCA2_test_B,temp_BRCA2_test_P))
}

train_for_BRCA1<-modelSet_commTrt[which(modelSet_commTrt$GENEINFO!="BRCA1"),]
train_for_BRCA2<-modelSet_commTrt[which(modelSet_commTrt$GENEINFO!="BRCA2"),]

VUS_BRCA1<-modelSet_commTrt[which(modelSet_commTrt$GENEINFO=="BRCA1"& modelSet_commTrt$CLNSIG=="Uncertain_significance" ),]
VUS_BRCA2<-modelSet_commTrt[which(modelSet_commTrt$GENEINFO=="BRCA2"& modelSet_commTrt$CLNSIG=="Uncertain_significance" ),]
train_for_BRCA1<-rbind(train_for_BRCA1,VUS_BRCA1)
train_for_BRCA2<-rbind(train_for_BRCA2,VUS_BRCA2)

for (i in 1:30) {
  d<-paste("train_",i,"_BRCA1",sep="")
  t<-paste("test_",i,"_BRCA1",sep="")
  
  d<-get(d)
  t<-get(t)
  
  print(sum(is.na(d[,na_names])))
  print(sum(is.na(t[,na_names])))
  
  d<-paste("train_",i,"_BRCA2",sep="")
  t<-paste("test_",i,"_BRCA2",sep="")
...
for(i in 1:30){
  ...
  assign(paste("train_",i,"_BRCA1",sep=""),d)
  assign(paste("test_",i,"_BRCA1",sep=""),t)
}
...
for(i in 1:30){
  ...
  assign(paste("train_",i,"_BRCA2",sep=""),d)
  assign(paste("test_",i,"_BRCA2",sep=""),t)
}
...
for(i in 1:30){
  ...
  Mean_list_BRCA1[[i]]<-attr(numeric_train_AllGene_2cls,"scaled:center")
  Sd_list_BRCA1[[i]]<-attr(numeric_train_AllGene_2cls,"scaled:scale")
  ...
  assign(paste("x_train_",i,"_BRCA1",sep=""),cbind(train_GI,binary_factor_train_AllGene_2cls,mul_factor_train_AllGene_2cls,numeric_train_AllGene_2cls)[!as.logical(VUS_tag),])
  assign(paste("x_test_",i,"_BRCA1",sep=""),cbind(test_GI,binary_factor_test_AllGene_2cls,mul_factor_test_AllGene_2cls,numeric_test_AllGene_2cls))
  assign(paste("x_pre_train_",i,"_BRCA1",sep=""),cbind(train_GI,binary_factor_train_AllGene_2cls,mul_factor_train_AllGene_2cls,numeric_train_AllGene_2cls)[as.logical(VUS_tag),])
  
  assign(paste("y_train_",i,"_BRCA1",sep=""),y_train_temp[!as.logical(VUS_tag)])
  assign(paste("y_test_",i,"_BRCA1",sep=""),y_test_temp)
}

for (i in 1:30) {
  d<-paste("x_train_",i,"_BRCA1",sep="")
  t<-paste("x_test_",i,"_BRCA1",sep="")
  v<-paste("x_pre_train_",i,"_BRCA1",sep="")
  ...
  assign(paste("x_train_",i,"_BRCA1",sep=""),d)
  assign(paste("x_test_",i,"_BRCA1",sep=""),t)
  assign(paste("x_pre_train_",i,"_BRCA1",sep=""),v)
}

##BRCA2
Mean_list_BRCA2<-list()
Sd_list_BRCA2<-list()
...
for(i in 1:30){
  ...
  numeric_train_AllGene_2cls<-scale(numeric_train_AllGene_2cls)
  Mean_list_BRCA2[[i]]<-attr(numeric_train_AllGene_2cls,"scaled:center")
  Sd_list_BRCA2[[i]]<-attr(numeric_train_AllGene_2cls,"scaled:scale")
  ...
  assign(paste("x_train_",i,"_BRCA2",sep=""),cbind(train_GI,binary_factor_train_AllGene_2cls,mul_factor_train_AllGene_2cls,numeric_train_AllGene_2cls)[!as.logical(VUS_tag),])
  assign(paste("x_test_",i,"_BRCA2",sep=""),cbind(test_GI,binary_factor_test_AllGene_2cls,mul_factor_test_AllGene_2cls,numeric_test_AllGene_2cls))
  assign(paste("x_pre_train_",i,"_BRCA2",sep=""),cbind(train_GI,binary_factor_train_AllGene_2cls,mul_factor_train_AllGene_2cls,numeric_train_AllGene_2cls)[as.logical(VUS_tag),])
  
  assign(paste("y_train_",i,"_BRCA2",sep=""),y_train_temp[!as.logical(VUS_tag)])
  assign(paste("y_test_",i,"_BRCA2",sep=""),y_test_temp)
}

for (i in 1:30) {
  d<-paste("x_train_",i,"_BRCA2",sep="")
  t<-paste("x_test_",i,"_BRCA2",sep="")
  v<-paste("x_pre_train_",i,"_BRCA2",sep="")
  ...
  assign(paste("x_train_",i,"_BRCA2",sep=""),d)
  assign(paste("x_test_",i,"_BRCA2",sep=""),t)
  assign(paste("x_pre_train_",i,"_BRCA2",sep=""),v)
}

for(i in 1:30){
  d<-paste("x_train_",i,"_BRCA1",sep="")
  t<-paste("y_train_",i,"_BRCA1",sep="")
  v<-paste("x_pre_train_",i,"_BRCA1",sep="")
  
  dd<-paste("x_test_",i,"_BRCA1",sep="")
  tt<-paste("y_test_",i,"_BRCA1",sep="")
  
  save(list=c(d,t,v,dd,tt),
       file = file.path("Data",
                        paste0(i, "-th_Transfer_setting_BRCA1_DiseaseSpecific_forNN_30sets_Nafill_standardized.RData")))
}

for(i in 1:30){
  d<-paste("x_train_",i,"_BRCA2",sep="")
  t<-paste("y_train_",i,"_BRCA2",sep="")
  v<-paste("x_pre_train_",i,"_BRCA2",sep="")
  
  dd<-paste("x_test_",i,"_BRCA2",sep="")
  tt<-paste("y_test_",i,"_BRCA2",sep="")
  
  save(list=c(d,t,v,dd,tt),
       file = file.path("Data",
                        paste0(i, "-th_Transfer_setting_BRCA2_DiseaseSpecific_forNN_30sets_Nafill_standardized.RData")))
}