...
t<-paste("y_train_",fold,"_MSH2",sep="")
...
t<-paste("y_test_",fold,"_MSH2",sep="")
...
#Fine_tuning
set.seed(24)
load(file.path("VUS_finetuning_pretraining", "MSH2_DS_finetuning_VUS_pretraining", "DS_Par_set_with_pretraining.RData"))
...
save(Total_pr_te, Total_pr_tr, predicted_tr, predicted_te,
     file = file.path("VUS_finetuning_pretraining","MSH2_DS_finetuning_VUS_pretraining", "result", paste0("MSH2_DS_", fold, "-", model, "-th_folds.RData")))
